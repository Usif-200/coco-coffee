...
const menuItems = [
  ...
  },
  {
    ...
    name: 'Cappuccino',
    description: "Espresso with steamed milk and foem",
    price: 5.3,
  },
  {
    ...
    <section className="pt-12 pb-16 xl:pt-16 xl:pb-36">
      <div className="container mx-auto">
        <div className="flex flex-col gap-4 mb-12 xl:mb-24">
          ...
          <div className="mb-4"><Separator bg="accent"/></div>
          <p className="text-center max-w-[620px] mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem qui in at, maxime suscipit dolorem ducimus aliquam magnam magni adipisci perferendis exercitationem laudantium quos quo inventore obcaecati fuga debitis amet.</p>
