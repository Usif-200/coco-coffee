...
function Hero() {
  return (
    <section className="h-[80vh] xl:h-screen relative text-white ">
        ...
        {/* video */}
        <video autoPlay loop muted className="absolute top-0 left-0 w-full h-full object-cover"> <source src="/assets/hero/video.mp4" type="video/mp4"/>
        Your browser dosenot support the video tag.
        </video>
